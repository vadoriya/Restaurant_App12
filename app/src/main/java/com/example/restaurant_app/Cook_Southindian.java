...
public class Cook_Southindian extends AppCompatActivity {
    Button backbutn;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cook_southimdian);
...
//                }
        ...
        backbutn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cook_Southindian.this,CookHome.class);
